module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert( 'issues', [
      ...
      { category_id: 1, user_id: 6, title: "Apollo Park", description: "fallen tree at park entrance", resolved: "in progress", username: "gerren", streetAddress: "1234 west ave S", city: "san francisco", state: "california", zipcode: "41310", numberOfOccurrences: 1, imagePath: "/images/tree.jpg", isFlagged: false, createdAt: new Date(), updatedAt: new Date() },
